...
l.data.reared<-na.omit(data.frame("ID"=l.data.reared$ID,"Lifespan"=l.data.reared$Lifespan,"Treatment"=l.data.reared$Treatment,"species"=l.data.reared$species,"Year"=l.data.reared$Year,"Date.Eclosed"=l.data.reared$Date.Eclosed,"egg_number"=l.data.reared$egg_number,"Egg.Size"=l.data.reared$Average.egg.perimeter))
...
summary(glm(Lifespan~Treatment*Date.Eclosed+Treatment*Year+egg_number+Egg.Size,data=Pr.l.data.reared,family='poisson'))
summary(Dp.glm <- glm(Lifespan~Treatment*Date.Eclosed+egg_number*Treatment+Egg.Size,data=Dp.l.data.reared,family='poisson'))
