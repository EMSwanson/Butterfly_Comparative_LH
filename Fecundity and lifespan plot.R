...
data.reared<-na.omit(data.frame("ID"=data.reared$ID,"Hindwing.Perimeter"=data.reared$Hindwing.Perimeter,"Lifespan"=data.reared$Lifespan,"Egg.Number"=data.reared$egg_number,"Treatment"=data.reared$Treatment,"species"=data.reared$species, "Year"=data.reared$Year,"Date.Eclosed"=data.reared$Date.Eclosed))
...
summary(glm(Lifespan~Egg.Number+Treatment+Year*Treatment+Date.Eclosed*Treatment,data=Pr.data.reared,family='poisson'))
...
summary(glm(Lifespan~Egg.Number*Treatment+Date.Eclosed*Treatment,data=Dp.data.reared,family="poisson"))
